    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Customer Service</h1>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
          ...
          <div class="card">
            <form method="POST">
              ...
              <div class="input-group input-group-sm" style="width: 150px;">
                <a href="tambahpaket.php"><button type="button" name="tambah" class="btn btn-block bg-gradient-info">Tambah</button></a>
              </div>
              <br>
              <div class="input-group input-group-sm" style="width: 200px;">
                <input name="keyword" type="text" name="table_search" class="form-control float-right" placeholder="No Resi">
                <div class="input-group-append">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <center>
                            <a href="deletepaket.php?noresi=<?= $data["noresi"]; ?>" class="btn btn-icon btn-danger"><i class="fas fa-trash"></i></a>
                          </center>
                        </td>
                      </tr>
                    <?php
