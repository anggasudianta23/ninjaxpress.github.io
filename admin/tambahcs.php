              ...
              <form method="POST">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="namacs" required>
                  </div>

                  <div class="form-group">
                    <label for="id">ID</label>
                    <?php
                    $max_noresi = mysqli_query($koneksi, "SELECT MAX(idcs) as max_noresi FROM cs");
                    ...
                    ?>
                    <input type="text" class="form-control" name="idcs" value="<?= $resi ?>" readonly>
                  </div>

                  <div class="form-group">
                    <label for="alamat">Alamat</label>
                    <input type="text" class="form-control" name="alamatcs" required>
                  </div>

                  <div class="form-group">
                    <label for="no_hp">No HP</label>
                    <input type="text" class="form-control" name="nohpcs" required>
                  </div>

                  <div class="form-group">
                    <label for="no_hp">Password</label>
                    <input type="password" class="form-control" name="passwordcs" required>
                  </div>
...
<?php
if (isset($_POST['buat'])) {
  if (is_numeric($_POST["nohpcs"])) {
    if (ctype_alpha($_POST["namacs"])) {
      $insert = mysqli_query($koneksi, "INSERT INTO cs (namacs, idcs, alamatcs, nohpcs, passwordcs) 
              VALUES ('$_POST[namacs]','$_POST[idcs]','$_POST[alamatcs]','$_POST[nohpcs]','$_POST[passwordcs]')");
      if ($insert) {
        echo
        "<script>alert('Berhasil ditambahkan');
                document.location.href = 'tabel_cs.php';</script>";
      } else {
        echo
        "<script> alert('Gagal ditambahkan');
                document.location.href = 'tambah_cs.php';</script>";
      }
    } else {
      echo
