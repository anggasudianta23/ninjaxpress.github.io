...
$datax = mysqli_query($koneksi, "SELECT * FROM kurir WHERE idkurir = '$idkurir'");
$arrxs = [];
              ...
              <form method="POST">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="namakurir" value="<?= $arrxs[0]['namakurir'] ?>" required>
                  </div>

                  <div class="form-group">
                    <label for="id">ID</label>
                    <input type="text" class="form-control" name="idkurir" value="<?= $arrxs[0]['idkurir'] ?>" readonly>
                  </div>

                  <div class="form-group">
                    <label for="alamat">Alamat</label>
                    <input type="text" class="form-control" name="alamatkurir" value="<?= $arrxs[0]['alamatkurir'] ?>" required>
                  </div>

                  <div class="form-group">
                    <label for="no_hp">No HP</label>
                    <input type="text" class="form-control" name="nohpkurir" value="<?= $arrxs[0]['nohpkurir'] ?>" required>
                  </div>

                  <div class="form-group">
                    <label for="no_hp">No Plat</label>
                    <input type="text" class="form-control" name="noplatkurir" value="<?= $arrxs[0]['noplatkurir'] ?>" required>
                  </div>

                  <div class="form-group">
                    <label for="no_hp">Password</label>
                    <input type="password" class="form-control" name="passwordkurir" value="<?= $arrxs[0]['passwordkurir'] ?>" required>
                  </div>
...
if (isset($_POST['buat'])) {
  if (is_numeric($_POST["nohpkurir"])) {
    if (ctype_alpha($_POST["namakurir"])) {
      ...
      nohpkurir = '$_POST[nohpkurir]', 
      alamatkurir = '$_POST[alamatkurir]',
      noplatkurir = '$_POST[noplatkurir]',  
      passwordkurir = '$_POST[passwordkurir]'
      WHERE idkurir = '$_GET[idkurir]'");
