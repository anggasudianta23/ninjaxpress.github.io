...
$datax = mysqli_query($koneksi, "SELECT * FROM pelanggan WHERE idpelanggan = '$idpelanggan'");
$arrxs = [];
              ...
              <form method="POST">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="namapelanggan" value="<?= $arrxs[0]['namapelanggan'] ?>" required>
                  </div>

                  <div class="form-group">
                    <label for="id">ID</label>
                    <input type="text" class="form-control" name="idpelanggan" value="<?= $arrxs[0]['idpelanggan'] ?>" readonly>
                  </div>

                  <div class="form-group">
                    <label for="alamat">Alamat</label>
                    <input type="text" class="form-control" name="alamatpelanggan" value="<?= $arrxs[0]['alamatpelanggan'] ?>" required>
                  </div>

                  <div class="form-group">
                    <label for="no_hp">No HP</label>
                    <input type="text" class="form-control" name="nohppelanggan" value="<?= $arrxs[0]['nohppelanggan'] ?>" required>
                  </div>

                  <div class="form-group">
                    <label for="no_hp">Password</label>
                    <input type="password" class="form-control" name="passwordpelanggan" value="<?= $arrxs[0]['passwordpelanggan'] ?>" required>
                  </div>
...
if (isset($_POST['buat'])) {
  if (is_numeric($_POST["nohppelanggan"])) {
    if (ctype_alpha($_POST["namapelanggan"])) {
      ...
      WHERE idpelanggan = '$_GET[idpelanggan]'");

      if ($insert) {
        echo
        "<script>alert('edit success');
                document.location.href = 'tabel_pelanggan.php';</script>";
      } else {
        echo
        "<script> alert('edit failed');
                document.location.href = 'tambah_pelanggan.php';</script>";
      }
    } else {
      echo
