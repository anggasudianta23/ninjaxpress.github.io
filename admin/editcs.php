...
$idcs = $_GET["idcs"];
$datax = mysqli_query($koneksi, "SELECT * FROM cs WHERE idcs = '$idcs'");
$arrxs = [];
              ...
              <form method="POST">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="namacs" value="<?= $arrxs[0]['namacs'] ?>" required>
                  </div>

                  <div class="form-group">
                    <label for="id">ID</label>

                    <input type="text" class="form-control" name="idcs" value="<?= $arrxs[0]['idcs'] ?>" readonly>
                  </div>

                  <div class="form-group">
                    <label for="alamat">Alamat</label>
                    <input type="text" class="form-control" name="alamatcs" value="<?= $arrxs[0]['alamatcs'] ?>" required>
                  </div>

                  <div class="form-group">
                    <label for="no_hp">No HP</label>
                    <input type="text" class="form-control" name="nohpcs" value="<?= $arrxs[0]['nohpcs'] ?>" required>
                  </div>

                  <div class="form-group">
                    <label for="no_hp">Password</label>
                    <input type="password" class="form-control" name="passwordcs" value="<?= $arrxs[0]['passwordcs'] ?>" required>
                  </div>
...
if (isset($_POST['buat'])) {
  if (is_numeric($_POST["nohpcs"])) {
    if (ctype_alpha($_POST["namacs"])) {
      ...
      namacs = '$_POST[namacs]', 
      nohpcs = '$_POST[nohpcs]', 
      alamatcs = '$_POST[alamatcs]', 
      passwordcs = '$_POST[passwordcs]'
      WHERE idcs = '$_GET[idcs]'");
